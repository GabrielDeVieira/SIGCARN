...
class TbInformacoes(models.Model):
    inf_codigo = models.AutoField(primary_key=True)
    inf_idapi = models.CharField(max_length=50, unique= True)
    ...
    inf_rcc_codigo = models.ForeignKey('TbRacacor',on_delete=models.CASCADE)
    inf_sex_codigo = models.ForeignKey('TbSexos',on_delete=models.CASCADE)
    inf_evolucaoCaso  = models.IntegerField(blank=True, null=True)
